...
void VkSwapChainManager::InitSwapchain()
{
	int width;
	int height;
	glfwGetFramebufferSize(windowHandler.p_window, &width, &height);
    vkb::SwapchainBuilder swapchainBuilder{VkDeviceManager::GetPhysicalDevice(),VkDeviceManager::GetDevice(),VkDeviceManager::GetSurface() };
...
void VkSwapChainManager::DeleteSwapchain()
{
